...
public:
    ...
    void HandleInput()
    {
        ...
        static std::map<int, int> MapUSBKeys = {
            { GLFW_KEY_F1, ExtKeys::F1 },
            { GLFW_KEY_F2, ExtKeys::F2 },
            { GLFW_KEY_F3, ExtKeys::F3 },
            { GLFW_KEY_F4, ExtKeys::F4 },
            { GLFW_KEY_F5, ExtKeys::F5 },
            { GLFW_KEY_F6, ExtKeys::F6 },
            { GLFW_KEY_F7, ExtKeys::F7 },
            { GLFW_KEY_F8, ExtKeys::F8 },
            { GLFW_KEY_F9, ExtKeys::F9 },
            { GLFW_KEY_F10, ExtKeys::F10 },
            { GLFW_KEY_F11, ExtKeys::F11 },
            { GLFW_KEY_F12, ExtKeys::F12 }
        };
        ...
        if (ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Escape))) {
            ...
            if (ImGui::IsKeyPressed(GLFW_KEY_1)) {
                ...
                for (int ch = GLFW_KEY_A; ch <= GLFW_KEY_Z; ch++) {
                    if (ImGui::IsKeyPressed(ch)) {
                        buffer.GetMode()->AddKeyPress((ch - GLFW_KEY_A) + 'a', mod);
                        handled = true;
                    }
                }
